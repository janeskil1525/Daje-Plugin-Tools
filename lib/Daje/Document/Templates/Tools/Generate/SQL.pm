...
(
    ...
    [% FOREACH field IN table.fields -%]
        ...
        CONSTRAINT [% project_name %]_[% table.table_name %]_[% project_name %]_[% field.fieldname %]_fkey FOREIGN KEY ([% project_name %]_[% field.fieldname -%]_fkey)
        REFERENCES [% project_name %]_[% field.fieldname %] ([% project_name %]_[% field.fieldname %]_pkey) MATCH SIMPLE
            ON UPDATE NO ACTION
            ON DELETE NO ACTION
            DEFERRABLE,
        [% ELSE -%]

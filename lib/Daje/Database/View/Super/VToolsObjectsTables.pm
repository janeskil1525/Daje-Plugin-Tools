...
has 'fields' => "tools_object_tables_pkey, tools_version_fkey, tools_objects_fkey, fieldname, length, scale, tools_objects_tables_datatypes_fkey, active, visible, datatype";

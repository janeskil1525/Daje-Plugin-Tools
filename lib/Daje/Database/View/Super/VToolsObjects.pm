...
has 'fields' => "tools_objects_pkey, editnum, insby, insdatetime, modby, moddatetime, tools_version_fkey, name, tools_object_types_fkey, tools_projects_fkey, workflow_fkey, workflow, visible, list, detail, generate_file, label, comment";

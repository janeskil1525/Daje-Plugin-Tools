package Daje::Database::View::Super::VToolsObjectsSql;
...
has 'fields' => 'tools_object_sql_pkey, tools_version_fkey, tools_objects_fkey, "name", sql_string, "comment"';
has 'primary_keys' => "tools_object_sql_pkey";
has 'foreign_keys' => "tools_version_fkey, tools_objects_fkey";
has 'view_name' => "v_tools_objects_sql";


sub load_objects_sql($self, $tools_objects_fkey, $tools_version_pkey) {
...
=head2 load_objects_sql($self,

 load_objects_sql($self,();

...
(
    ...
    workflow_fkey BIGINT NOT NULL,
        CONSTRAINT tools_projects_workflow_fkey FOREIGN KEY (workflow_fkey)
        REFERENCES workflow (workflow_pkey) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        DEFERRABLE,
...
CREATE OR REPLACE VIEW public.v_tools_projects_workflow_fkey
 AS

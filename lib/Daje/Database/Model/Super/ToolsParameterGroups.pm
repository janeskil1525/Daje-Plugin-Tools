...
Daje::Database::Model::Super::ToolsParameterGroups
...
=head2 load_tools_parameter_groups($self)

 load_tools_parameter_groups($self)();

=head2 load_tools_parameter_groups_pkey($self,

 load_tools_parameter_groups_pkey($self,();

...
has 'fields' => 'tools_object_tables_pkey, editnum, insby, insdatetime, modby, moddatetime, tools_version_fkey, tools_objects_fkey, fieldname, tools_objects_tables_datatypes_fkey, length, scale, active, visible, "notnull", "default", foreign_key, "unique", "mandatory", "project", "dropfield", "label", "tooltip", "comment"';

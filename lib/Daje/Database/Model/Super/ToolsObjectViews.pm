...
Daje::Database::Model::Super::ToolsObjectViews
...
=head2 load_tools_object_views_pkey($self,

 load_tools_object_views_pkey($self,();

=head2 load_tools_objects_views_fkey($self,

 load_tools_objects_views_fkey($self,();

...
has 'fields' => "tools_objects_pkey, editnum, insby, insdatetime, modby, moddatetime, tools_version_fkey, name, active, tools_object_types_fkey,workflow, visible, list, detail, connector";
